...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 0.6, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0.2, 0.5), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 0,  1), glm::vec3(0, 0.5, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1,  0), glm::vec3(0.2, 1, 0.6), glm::vec3(0.2, 0.8, 0.6)),
        };
        vector<VertexFormat> vertices3
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.3, 0.8)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 0.5, 1), glm::vec3(0.5, 0.1, 0.5)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.5, 1, 1), glm::vec3(0.6, 0.2, 0.5)),
        };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(2, 2, 2), glm::vec3(0.5f));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-2, 2, -2), glm::vec3(0.25f));

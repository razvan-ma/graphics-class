...
void Lab9::Update(float deltaTimeSeconds)
{
    ...
    {
        glm::mat4 modelMatrix = glm::mat4(1);
        modelMatrix = glm::translate(modelMatrix, glm::vec3(-5, 1.f, -3));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(1.f));
        mixTextures = 1;
        RenderSimpleMesh(meshes["square"], shaders["LabShader"], modelMatrix, mapTextures["earth"], mapTextures["crate"]);
        mixTextures = 0;
    }
